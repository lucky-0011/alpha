import{w as h,p as w,y as m,z as f,i as v,g as b,x}from"./index-CCxaLuPB.js";import{r as u,c as g}from"./if-defined-BTtgtc3a.js";const e=w({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),y={state:e,subscribe(o){return f(e,()=>o(e))},subscribeKey(o,t){return m(e,o,t)},showTooltip({message:o,triggerRect:t,variant:i}){e.open=!0,e.message=o,e.triggerRect=t,e.variant=i},hide(){e.open=!1,e.message="",e.triggerRect={width:0,height:0,top:0,left:0}}},s=h(y),R=v`
  :host {
    pointer-events: none;
  }
