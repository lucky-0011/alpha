import{i as E,r as j,f as z,g as v,x as u,f1 as R,R as l,v as h,m as C,S as f,l as M,C as P,a6 as y,j as c,a3 as V,aK as B,h as H}from"./index-6ZO6jKQK.js";import{n as I,c as d,r as m,U as N}from"./if-defined-D_715Pgs.js";import"./index-B_cyY1fP.js";import"./index-Bx0bWmYT.js";import"./index-sJP39poa.js";import{e as q,n as K}from"./ref-CQ-Dmw0Q.js";import"./index-HsXCQXt9.js";import"./index-BYDEZ8pk.js";import"./index-ChXxPU4J.js";const G=E`
  :host {
    position: relative;
...
`;var A=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let g=class extends v{constructor(){super(...arguments),this.disabled=!1,this.value=""}render(){return u`<input
      ...
      value=${this.value}
    /> `}};g.styles=[j,z,G];A([I({type:Boolean})],g.prototype,"disabled",void 0);A([I({type:String})],g.prototype,"value",void 0);g=A([d("wui-input-numeric")],g);const Y=E`
  :host {
    position: relative;
    display: block;
  }
...
`;var _=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i},S;let p=S=class extends v{firstUpdated(){this.startOTPTimeout()}disconnectedCallback(){clearTimeout(this.OTPTimeout)}constructor(){var e;super(),this.loading=!1,this.timeoutTimeLeft=R.getTimeToNextEmailLogin(),this.error="",this.otp="",this.email=(e=l.state.data)==null?void 0:e.email,this.authConnector=h.getAuthConnector()}render(){if(!this.email)throw new Error("w3m-email-otp-widget: No email provided");const e=!!this.timeoutTimeLeft,t=this.getFooterLabels(e);return u`
    ...
    `}startOTPTimeout(){this.timeoutTimeLeft=R.getTimeToNextEmailLogin(),this.OTPTimeout=setInterval(()=>{this.timeoutTimeLeft>0?this.timeoutTimeLeft=R.getTimeToNextEmailLogin():clearInterval(this.OTPTimeout)},1e3)}async onOtpInputChange(e){var t;try{this.loading||(this.otp=e.detail,this.shouldSubmitOnOtpChange()&&(this.loading=!0,await((t=this.onOtpSubmit)==null?void 0:t.call(this,this.otp))))}catch(n){this.error=C.parseError(n),this.loading=!1}}async onResendCode(){try{if(this.onOtpResend){if(!this.loading&&!this.timeoutTimeLeft){if(this.error="",this.otp="",!h.getAuthConnector()||!this.email)throw new Error("w3m-email-otp-widget: Unable to resend email");this.loading=!0,await this.onOtpResend(this.email),this.startOTPTimeout(),f.showSuccess("Code email resent")}}else this.onStartOver&&this.onStartOver()}catch(e){f.showError(e)}finally{this.loading=!1}}getFooterLabels(e){return this.onStartOver?{title:"Something wrong?",action:`Try again ${e?`in ${this.timeoutTimeLeft}s`:""}`}:{title:"Didn't receive it?",action:`Resend ${e?`in ${this.timeoutTimeLeft}s`:"Code"}`}}shouldSubmitOnOtpChange(){return this.authConnector&&this.otp.length===S.OTP_LENGTH}};p.OTP_LENGTH=6;p.styles=J;_([m()],p.prototype,"loading",void 0);_([m()],p.prototype,"timeoutTimeLeft",void 0);_([m()],p.prototype,"error",void 0);p=S=_([d("w3m-email-otp-widget")],p);var Q=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let L=class extends p{constructor(){super(...arguments),this.onOtpSubmit=async e=>{var t,n;try{if(this.authConnector){const o=M.state.activeChain,i=P.getConnections(o),r=(t=y.state.remoteFeatures)==null?void 0:t.multiWallet,s=i.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),o)await P.connectExternal(this.authConnector,o);else throw new Error("Active chain is not set on ChainControll");if(c.sendEvent({type:"track",event:"CONNECT_SUCCESS",properties:{method:"email",name:this.authConnector.name||"Unknown"}}),(n=y.state.remoteFeatures)!=null&&n.emailCapture)return;if(y.state.siwx){V.close();return}if(s&&r){l.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}V.close()}}catch(o){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:C.parseError(o)}}),o}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};L=Q([d("w3m-email-verify-otp-view")],L);const X=E`
  wui-icon-box {
...
`;var $=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let b=class extends v{constructor(){var e,t;super(...arguments),this.formRef=q(),this.initialEmail=((e=l.state.data)==null?void 0:e.email)??"",this.redirectView=(t=l.state.data)==null?void 0:t.redirectView,this.email="",this.loading=!1}firstUpdated(){var e;(e=this.formRef.value)==null||e.addEventListener("keydown",t=>{t.key==="Enter"&&this.onSubmitEmail(t)})}render(){return u`
